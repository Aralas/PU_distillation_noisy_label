...
precision_dir += '/benchmark_ResNet%d'%
...
record_file.write(
    ...
    seed, noise_level, clean_data_size, additional_data_limitation[0], additional_data_limitation[1],
    positive_threshold, add_criterion, K_iteration, N_bagging, batch_size, epochs, learning_rate,
